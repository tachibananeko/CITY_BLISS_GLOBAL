...
(self.webpackChunkelementor_pro = self.webpackChunkelementor_pro || []).push([
  [
    ...
    443, 838, 685, 858, 102, 1, 124, 859, 979, 497, 800, 149, 153, 356, 495,
    157, 244, 209, 188, 699,
  ],
  {
    9978: (e, t, n) => {
      ...
      class AjaxPagination extends elementorModules.frontend.handlers.Base {
        ...
        linksEventListeners() {
          this.elements.links.length &&
            "ajax" === this.getElementSettings("pagination_load_type") &&
            this.elements.links.forEach((e) => {
        ...
        updateURLQueryString(e) {
          ...
          s.forEach((e, t) => {
            ...
            s.has("e-page-" + this.elementId) ||
              n.delete("e-page-" + this.elementId),
        ...
        maybeScrollToTop() {
          ...
          const e = document.querySelector(
            `.elementor-element-${this.elementId}`
          );
        ...
        handleSuccessFetch(e) {
          ...
          const t = this.getSettings("selectors"),
            n = e.querySelector(
              `[data-id="${this.elementId}"] ${t.widgetContainer}`
            ),
        ...
        afterInsertPosts() {
          const e = this.getSettings("selectors"),
            t = document.querySelectorAll(
              `[data-id="${this.elementId}"] ${e.postWrapperTag}`
            );
    ...
    3651: (e, t, n) => {
      ...
      class BaseFilterFrontendModule extends elementorModules.Module {
        ...
        updateURLQueryString(e, t) {
          ...
          n.forEach((t, n) => {
            n.startsWith("e-filter") || i.append(n, t),
              n.startsWith("e-page-" + e) && i.delete(n);
          });
          ...
          (r =
            o.pageNum > 1
              ? r
                ? this.formatQueryString(o.baseUrl, r)
                : o.baseUrl
              : r
              ? `?${r}`
              : location.pathname),
        ...
        refreshLoopWidget(e, t) {
          ...
          if (!n) return;
          this.ajaxHelper || (this.ajaxHelper = new o.default()),
    ...
    9318: (e, t, n) => {
      ...
      class MegaMenu extends elementorModules.frontend.handlers.NestedTabs {
        ...
        getDefaultSettings() {
          const e = super.getDefaultSettings();
          return (
            (e.selectors.widgetContainer = ".e-n-menu"),
            (e.selectors.dropdownMenuToggle = ".e-n-menu-toggle"),
            (e.selectors.menuWrapper = ".e-n-menu-wrapper"),
            (e.selectors.headingContainer = ".e-n-menu-heading"),
            (e.selectors.tabTitle = ".e-n-menu-title"),
            (e.selectors.tabDropdown = ".e-n-menu-dropdown-icon"),
            (e.selectors.menuContent = ".e-n-menu-content"),
            (e.selectors.tabContent = ".e-n-menu-content > .e-con"),
            (e.selectors.anchorLink = ".e-anchor a"),
            (e.classes.anchorItem = "e-anchor"),
            (e.classes.activeAnchorItem = "e-current"),
            (e.autoExpand = !1),
            (e.autoFocus = !1),
            (e.ariaAttributes.titleStateAttribute = "aria-expanded"),
            (e.ariaAttributes.activeTitleSelector = '[aria-expanded="true"]'),
            e
          );
        }
        getDefaultElements() {
          ...
          return (
            (e.$widgetContainer = this.$element.find(t.widgetContainer)),
            (e.$dropdownMenuToggle = this.$element.find(t.dropdownMenuToggle)),
            (e.$menuWrapper = this.$element.find(t.menuWrapper)),
            (e.$menuContent = this.$element.find(t.menuContent)),
            (e.$headingContainer = this.$element.find(t.headingContainer)),
            (e.$tabTitles = this.$element.find(t.tabTitle)),
            (e.$tabDropdowns = this.$element.find(t.tabDropdown)),
        ...
        handleContentContainerPosition() {
          ...
          (e =
            ...
            this.elements.$tabContents.filter(
              this.getTabContentFilterSelector(n)
            )),
        ...
        getMenuItemContainerAbsolutePosition(e) {
          const t = e.data("tab-index"),
            n = this.elements.$tabDropdowns
              .filter(this.getTabTitleFilterSelector(t))[0]
              .closest(this.getSettings("selectors").tabTitle)
        ...
        activateTab(e) {
          const t = this.getSettings(),
            ...
            r = this.elements.$menuContent;
          this.addAnimationToContentIfNeeded(e),
            o[t.showTabFn](i, () => this.onShowTabContent(o)),
            s.attr(this.getTitleActivationAttributes()),
            s.prev("a").attr(this.getTitleActivationAttributes("link")),
            o.addClass(n),
            o.css({ display: "var(--display)" }),
            o.removeAttr("display"),
            r.addClass(n),
            elementorFrontend.isEditMode() &&
              o.length &&
              this.activeContainerWidthListener(o);
        }
        deactivateActiveTab(e) {
          ...
          this.setTabDeactivationAttributes(o, e),
            r.removeClass(n),
            r[t.hideTabFn](0, () => this.onHideTabContent(r)),
            this.removeAnimationFromContentIfNeeded(),
            a.removeClass(n),
            elementorFrontend.isEditMode() &&
              r.length &&
              this.observedContainer?.unobserve(r[0]);
        }
        ...
        onHideTabContent() {
          this.elements.$widgetContainer.hasClass("content-above") &&
            this.resetContentContainersPosition();
        }
        changeActiveTab(e) {
          let t =
        ...
        changeActiveTabByKeyboard(e, t) {
          if (t.widgetId !== this.getID()) return;
        ...
        onTabClick(e) {
          ...
          const t = this.getSettings("selectors"),
            n = e?.currentTarget,
            s = n?.querySelector(t.tabDropdown),
            i = this.getTabIndex(s);
          this.changeActiveTab(i, !0);
        }
        bindEvents() {
          this.elements.$tabTitles.on(this.getTabEvents()),
            ...
            elementorFrontend.elements.$window.on(
              "elementor/mega-menu/dropdown-toggle-by-keyboard",
              this.onClickToggleDropdownMenuByKeyboard.bind(this)
            ),
            elementorFrontend.elements.$window.on(
              "resize",
        ...
        onMouseTitleEnter(e) {
          ...
          "true" === i?.getAttribute(n) ||
            (this.resetTabindexAttributes(),
            this.changeActiveTab(i?.getAttribute("data-tab-index"), !0));
        }
        onClickToggleDropdownMenu(e) {
          ...
          this.elements.$dropdownMenuToggle.attr(n, i),
        ...
        onClickToggleDropdownMenuByKeyboard(e, t) {
          t.widgetId === this.getID() && this.onClickToggleDropdownMenu(t.show);
        }
        ...
        isMenuContentHovered() {
          const e = this.getSettings();
          return (
            this.$element.find(`${e.selectors.menuContent}:hover`).length > 0
          );
        }
        ...
        isHoveredDropdownMenu(e, t) {
          return (
            (!e || !this.didCursorMoveSidewaysOrDown(t)) &&
            this.isMenuContentHovered()
          );
        }
        onMouseLeave(e) {
          e.preventDefault();
          const t = e?.currentTarget?.classList.contains("e-con");
          this.isHoveredDropdownMenu(t, e) ||
        ...
        setLayoutType() {
          const e =
            "flex" === this.elements.$headingContainer.css("display")
              ? "horizontal"
              : "dropdown";
    ...
    6921: (e, t) => {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.default = void 0);
      class MenuTitleKeyboardHandler extends elementorModules.frontend.handlers
        .NestedTitleKeyboardHandler {
        __construct() {
          super.__construct(...arguments),
            (this.handleMenuToggleKeydown =
              this.handleMenuToggleKeydown.bind(this));
        }
        getDefaultSettings() {
          const e = super.getDefaultSettings();
          return (
            (e.selectors.widgetInnerWrapper = ".e-n-menu"),
            (e.selectors.menuToggle = ".e-n-menu-toggle"),
            (e.selectors.itemTitle = ".e-focus"),
            (e.selectors.itemContainer = ".e-n-menu-content > .e-con"),
            (e.ariaAttributes.titleStateAttribute = "aria-expanded"),
            (e.ariaAttributes.activeTitleSelector = '[aria-expanded="true"]'),
            (e.datasets.titleIndex = "data-focus-index"),
            e
          );
        }
        getDefaultElements() {
        ...
        setTitleTabindex(e) {
          ...
          t.attr("tabindex", "0"),
            t.next(".e-n-menu-dropdown-icon").attr("tabindex", "0"),
            t.prev("a").attr("tabindex", "0");
        }
        ...
        handleTitleEscapeKeyEvents(e) {
          ...
          const t = this.getSettings("selectors");
          "dropdown" ===
            this.$element.find(t.widgetInnerWrapper).data("layout") &&
            (elementorFrontend.elements.$window.trigger(
              "elementor/mega-menu/dropdown-toggle-by-keyboard",
              { widgetId: this.getID() }
            ),
            this.$element.find(t.menuToggle).trigger("focus")),
            elementorFrontend.elements.$window.trigger(
              "elementor/nested-elements/activate-by-keyboard",
              { widgetId: this.getID() }
            );
        ...
        function createDOMPurify() {
                ...
                if (
                  ...
                  (Ue = Ue =
                    -1 === Ve.indexOf(e.PARSER_MEDIA_TYPE)
                      ? Qe
                      : e.PARSER_MEDIA_TYPE),
                  (Ge = "application/xhtml+xml" === Ue ? g : h),
                  (le =
                    "ALLOWED_TAGS" in e
                  ...
                  (ze =
                    "ALLOWED_NAMESPACES" in e
                      ? addToSet({}, e.ALLOWED_NAMESPACES, g)
                      : qe),
                  (Oe =
                  ...
                  (Ie = "USE_PROFILES" in e && e.USE_PROFILES),
                  ...
                  Ie &&
                    ((le = addToSet({}, [...M])),
                    (ce = []),
                    !0 === Ie.html && (addToSet(le, b), addToSet(ce, k)),
                    !0 === Ie.svg &&
                      (addToSet(le, w), addToSet(ce, F), addToSet(ce, I)),
                    !0 === Ie.svgFilters &&
                      (addToSet(le, C), addToSet(ce, F), addToSet(ce, I)),
                    !0 === Ie.mathMl &&
                      (addToSet(le, E), addToSet(ce, x), addToSet(ce, I))),
                  e.ADD_TAGS &&
                    (le === de && (le = clone(le)),
                  ...
                  e.ADD_URI_SAFE_ATTR && addToSet(Oe, e.ADD_URI_SAFE_ATTR, Ge),
                  e.FORBID_CONTENTS &&
                    (Ae === Le && (Ae = clone(Ae)),
          ...
          const it = function _checkValidNamespace(e) {
            ...
            ht = function _isValidAttribute(e, t, n) {
              if (Te && ("id" === t || "name" === t) && (n in i || n in Ke))
                return !1;
              if (fe && !ge[t] && y(se, t));
              else if (pe && y(ie, t));
              else if (!ce[t] || ge[t]) {
              ...
              for (i = o.length; i--; ) {
                ...
                if (ht(d, s, n)) {
                  if (
                    ...
                    V &&
                      "object" == typeof O &&
                      "function" == typeof O.getAttributeType)
                  )
                    if (l);
                    else
                      switch (O.getAttributeType(d, s)) {
                        case "TrustedHTML":
                          n = V.createHTML(n);
                          break;
          ...
          return (
            (DOMPurify.sanitize = function (e) {
              ...
              const d = lt(xe ? e : t);
              for (; (i = d.nextNode()); )
                mt(i) || (i.content instanceof r && ft(i.content), pt(i));
              if (xe) return e;
              if (Ce) {
                if ($e)
                  for (o = K.call(t.ownerDocument); t.firstChild; )
              ...
              return (
                Se &&
                  ...
                  y(W, t.ownerDocument.doctype.name) &&
