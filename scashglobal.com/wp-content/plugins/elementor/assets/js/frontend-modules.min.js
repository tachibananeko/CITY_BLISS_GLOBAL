        ...
        static attachDelegatedHandlers() {
          ...
          this.addEventListenerTracked(
            ...
            (t) => {
              ...
              if (n && !this.isExcludedElement(n))
                return e.includes(n.id)
                  ? void this.trackControl(n, i.CONTROL_TYPES.FILTER)
                  : void this.trackControl(n, i.CONTROL_TYPES.BUTTON);
              const s = r.closest("a");
              !s ||
                this.isExcludedElement(s) ||
                this.isNavigationLink(s) ||
                this.trackControl(s, i.CONTROL_TYPES.LINK);
            },
            { capture: !1 }
          ),
            this.addEventListenerTracked(document, "change", (e) => {
              ...
              if (!t) return;
              const r = t.closest(".components-toggle-control");
              if (r && !this.isExcludedElement(r))
      ...
      class NavigationTracking extends s.default {
        ...
        static determineNavArea(e) {
          if (e.closest("li.menu-top")) {
            if (e.closest(c)) {
              return e.closest(l).classList.contains("wp-not-current-submenu")
