(astraToggleSetupPro = function (e, t, a) {
  ...
  if (
      ...
      (n =
        "off-canvas" === e || "full-width" === e
          ? ((o = document.querySelectorAll(
            ...
            (l = t.classList.contains("ast-header-break-point")
          ...
          ? ((o = document.querySelectorAll("#ast-mobile-header")),
            (s = !(
              0 <
              (n = (l = document.querySelectorAll(
                "#ast-mobile-header .main-header-menu-toggle"
              )).length)
            ))
              ? 1
              : n)
          : ((o = document.querySelectorAll("#ast-desktop-header")),
    ...
    for (var r = 0; r < n; r++)
      if (
        (s ||
          (l[r].setAttribute("data-index", r),
          a[r] ||
            ((a[r] = l[r]),
            l[r].addEventListener("click", astraNavMenuToggle, !1))),
        void 0 !== o[r])
      )
        for (var d, i = 0; i < o.length; i++)
          if (
            ...
            (d = document
              ...
              : o[i].querySelectorAll("ul.main-header-menu .ast-menu-toggle"))
              .length
          )
  ...
  (astraNavMenuTogglePro = function (e, t, a, n) {
    ...
    var o = e.target.closest("#ast-desktop-header"),
      ...
      s =
        ((o =
          null != o && "" !== o
            ? o.querySelector(".main-header-menu-toggle")
    ...
    if ("desktop" === e.currentTarget.trigger_type)
      return (
        ...
        void (o.classList.contains("toggled")
          ? (t.classList.add("ast-main-header-nav-open"),
            "dropdown" === a && (l.style.display = "block"))
    ...
    for (
      ...
      for (var i = r[d].querySelectorAll(".sub-menu"), c = 0; c < i.length; c++)
        i[c].style.display = "none";
    }
    -1 !== (n.getAttribute("class") || "").indexOf("main-header-menu-toggle") &&
    ...
    "enabled" == (astraAddon.hook_sticky_header || "") &&
      ...
      jQuery(r).scrollTop() > i
        ? "none" == t.options.header_style &&
          ("enabled" == t.options.active_shrink && t.hasShrink(t, "stick"),
          o.hasClass("ast-custom-header") &&
...
!(function (n, h) {
  ...
  "disabled" != y &&
    ("enabled" === y && ((_ = b), (u = g), (k = v)),
    0 < n("header .site-logo-img img").length &&
      (-1 ===
        (b =
          0 ==
          (b =
            void 0 === (b = (y = n("header .site-logo-img img")).attr("height"))
              ? y.height()
              : b)
            ? ""
            : b)
    ...
    (_ || u || k) &&
      ...
      jQuery(l).on("ready astLayoutWidthChanged", function (e) {
        ...
        "1" == x
          ...
          : "none" == f
          ? c
            ? ("both" === Q ? ["desktop", "mobile"] : [Q]).forEach(function (
                e
              ) {
                var t;
                ("1" != u && "on" != u && "disabled" != u) ||
          ...
          ("mobile" != Q && "both" != Q) ||
            ...
            jQuery("#ast-fixed-header .main-header-menu-toggle").click(
              function (e) {
                var t;
  ...
  [].slice.call(items).forEach(function (f) {
    jQuery(f).hover(function () {
      var e,
        ...
        u = u.parent(),
        o = jQuery(this);
      (o.hasClass("full-width-mega") ||
        o.hasClass("full-stretched-width-mega")) &&
        (m = jQuery(m).closest(".ast-container")),
        parseInt(jQuery(window).width()) > parseInt(astra.break_point) &&
        "ast-hf-mobile-menu" !== o.parent().attr("id") &&
        "ast-desktop-toggle-menu" !== o.parent().attr("id")
          ? ((e = m.width()),
            (i = m.offset()),
            (m =
              (a = o.offset()).left -
              (i.left + parseFloat(m.css("paddingLeft")))),
            (d = e - (a.left + i.left) + 130),
            (t = u.width()),
            (l = u.offset()),
            (a = a.left - (l.left + parseFloat(u.css("paddingLeft")))),
            o.hasClass("custom-width-mega") &&
              ((r = (r =
                window
                  .getComputedStyle(
                    o.find(".astra-mega-menu-width-custom")[0],
                    "::before"
                  )
                  .getPropertyValue("content") || 1200).replace(/[^0-9]/g, "")),
              (n =
                (r = parseInt(r)) <= e
                  ? ((n = parseInt(e - r)), (s = parseInt(m - n)), i.left - s)
                  : ((n = parseInt(r - e)),
                    (s = parseInt(m + n)),
                    i.left + s))),
            o.hasClass("menu-container-width-mega") &&
              ((l = jQuery(f).parents(".main-navigation")),
              u.hasClass("ast-above-header")
                ? (l = jQuery(".ast-above-header-navigation"))
                : u.hasClass("ast-below-header") &&
                  (l = jQuery(".ast-below-header-actual-nav")),
              (e =
                ($target_container = l.length ? l : o.parent("ul")).width() +
                "px"),
              (i =
                jQuery(window).width() -
                ($target_container.offset().left +
                  $target_container.outerWidth())),
              (u = o.offset()),
              (l = jQuery(window).width() - i - u.left),
              (m = parseInt($target_container.width() - l)),
              (d =
                parseInt(e) -
                o.outerWidth() -
                parseInt($target_container.width() - l))),
            o.hasClass("full-width-mega")
              ? (o
                  .find(".astra-full-megamenu-wrapper")
                  .css({ left: "-" + a + "px", width: t }),
                o.find(".astra-megamenu").css({ width: e }))
              : o.hasClass("full-stretched-width-mega")
              ? o
                  .find(".astra-full-megamenu-wrapper")
                  .css({ left: "-" + a + "px", width: t })
              ...
              ? astra.isRtl
                ? o
                    ...
                    .css({ right: "-" + n + "px", width: r + "px" })
                : o
                    .find(".astra-mega-menu-width-custom")
                    .css({ left: "-" + s + "px", width: r + "px" })
              : astra.isRtl
              ? o
                  .find(".astra-megamenu")
                  .css({ right: "-" + d + "px", width: e })
              : o
                  .find(".astra-megamenu")
                  .css({ left: "-" + m + "px", width: e }))
          : astra.isRtl
          ? (o
              .find(".astra-megamenu")
...
apply_megamenu_width_styles(),
  ...
  [].slice.call(items).forEach(function (o) {
    var e = jQuery(o).parents(".ast-container"),
      ...
      h = e.parent(),
      c = jQuery(o);
    (c.hasClass("full-width-mega") ||
      c.hasClass("full-stretched-width-mega")) &&
      ((f = jQuery(f).closest(".ast-container")),
      c.find(".astra-full-megamenu-wrapper").removeClass("ast-hidden")),
      c.find(".menu-link").focusin(function (e) {
        var t, a, s, n, r, i, l, d, u, m;
        astra.is_header_footer_builder_active ||
          (c.find(".sub-menu").addClass("astra-megamenu-focus"),
          c
            .find(".astra-full-megamenu-wrapper")
            .addClass("astra-megamenu-wrapper-focus")),
          c.find(".sub-menu").removeClass("ast-hidden"),
          parseInt(jQuery(window).width()) > parseInt(astra.break_point) &&
          "ast-hf-mobile-menu" !== c.parent().attr("id") &&
          "ast-desktop-toggle-menu" !== c.parent().attr("id")
            ? ((t = f.width()),
              (d = f.offset()),
              (u =
                (s = c.offset()).left -
                (d.left + parseFloat(f.css("paddingLeft")))),
              (m = s.left + d.left),
              (a = h.width()),
              (l = h.offset()),
              (s = s.left - (l.left + parseFloat(h.css("paddingLeft")))),
              c.hasClass("custom-width-mega") &&
                ((i = (i =
                  window
                    .getComputedStyle(
                      c.find(".astra-mega-menu-width-custom")[0],
                      "::before"
                    )
                    .getPropertyValue("content") || 1200).replace(
                  /[^0-9]/g,
                  ""
                )),
                (r =
                  (i = parseInt(i)) <= t
                    ? ((r = parseInt(t - i)), (n = parseInt(u - r)), d.left - n)
                    : ((r = parseInt(i - t)),
                      (n = parseInt(u + r)),
                      d.left + n))),
              c.hasClass("menu-container-width-mega") &&
                ((l = jQuery(o).parents(".main-navigation")),
                h.hasClass("ast-above-header")
                  ? (l = jQuery(".ast-above-header-navigation"))
                  : h.hasClass("ast-below-header") &&
                    (l = jQuery(".ast-below-header-actual-nav")),
                (t =
                  ($target_container = l.length ? l : c.parent("ul")).width() +
                  "px"),
                (d =
                  jQuery(window).width() -
                  ($target_container.offset().left +
                    $target_container.outerWidth())),
                (l = c.offset()),
                (d = jQuery(window).width() - d - l.left),
                (u = parseInt($target_container.width() - d)),
                (m =
                  parseInt(t) -
                  c.outerWidth() -
                  parseInt($target_container.width() - d))),
              c.hasClass("full-width-mega")
                ? (c
                    .find(".astra-full-megamenu-wrapper")
                    .css({ left: "-" + s + "px", width: a }),
                  c.find(".astra-megamenu").css({ width: t }))
                : c.hasClass("full-stretched-width-mega")
                ? c
                    .find(".astra-full-megamenu-wrapper")
                    .css({ left: "-" + s + "px", width: a })
                ...
                ? astra.isRtl
                  ? c
                      .find(".astra-mega-menu-width-custom")
                      .css({ right: "-" + r + "px", width: i + "px" })
                  : c
                      .find(".astra-mega-menu-width-custom")
                      .css({ left: "-" + n + "px", width: i + "px" })
                : astra.isRtl
                ? c
                    .find(".astra-megamenu")
                    .css({ right: "-" + m + "px", width: t })
                : c
                    .find(".astra-megamenu")
                    .css({ left: "-" + u + "px", width: t }))
            : astra.isRtl
            ? (c
                .find(".astra-megamenu")
                .css({ right: "", width: "", "background-image": "" }),
      ...
      astra.is_header_footer_builder_active ||
        (c.find(".menu-link").keydown(function (e) {
          9 == e.which &&
            e.shiftKey &&
            (c.find(".sub-menu").removeClass("astra-megamenu-focus"),
            c
              .find(".astra-full-megamenu-wrapper")
...
!(function () {
  ...
  (e = "iPhone" == navigator.userAgent.match(/iPhone/i) ? "iphone" : ""),
    ...
    (document.body.className += " " + t);
  for (
    var a = document.querySelectorAll("a.astra-search-icon:not(.slide-search)"),
      s = 0;
    a.length > s;
    s++
  )
              ...
              c
                ...
                : ((a = s[r]),
                  ...
                  document.body.classList.contains("ast-header-break-point") &&
                    ...
                    null !== (o = document.querySelector(".main-header-bar")) &&
                      null !== t &&
                      ((t = t.offsetHeight),
                      (o = o.offsetHeight),
                      (t =
  ...
  for (
    var c = document.querySelectorAll(".ast-search-box .close"),
      s = 0,
      r = c.length;
    s < r;
    ++s
