  ...
  })(
    {
        ...
        function (e, t, r) {
          t.exports = function (e) {
            ...
            if (1 < e.lines.length && "flex-start" === e.style.alignContent)
              ...
              for (
                t =
                  (r = (2 * e.flexStyle.crossSpace) / (2 * e.lines.length)) / 2;
                (l = e.lines[++n]);
          ...
          t.exports = function (e) {
            for (var t, r = -1; (line = e.lines[++r]); )
              for (t = -1; (child = line.children[++t]); ) {
                ...
                "flex-start" === (l = "auto" === l ? e.style.alignItems : l)
                  ...
                  return (
                    "auto" === t.flexStyle.main
                      ? (t.flexStyle.main =
                          ...
                          (parseFloat(t.style.flexGrow) / l) * r.mainSpace)
                      : (t.flexStyle.main +=
                          (parseFloat(t.style.flexGrow) / l) * r.mainSpace),
            ...
            r.mainSpace < 0 &&
              ...
              ((r.main = n(
                ...
                function (e, t) {
                  return (
                    (t.flexStyle.main +=
                      (parseFloat(t.style.flexShrink) / l) * r.mainSpace),
                    (t.flexStyle.mainOuter =
                      t.flexStyle.main +
                      t.flexStyle.mainBefore +
                      t.flexStyle.mainAfter),
      ...
      7: [
        function (n, e, t) {
          e.exports = function (e) {
            for (var t, r, l = -1; (t = e.children[++l]); )
              n("./flex-direction")(t, e.style.flexDirection);
            for (
              n("./flex-direction")(e, e.style.flexDirection),
                n("./order")(e),
                n("./flexbox-lines")(e),
                n("./align-content")(e),
                l = -1;
              ...
              (r.mainSpace =
                ...
                n("./margin-main")(r),
                n("./margin-cross")(r),
                n("./justify-content")(r, e.style.justifyContent, e);
            n("./align-items")(e);
          };
        },
        {
        ...
        function (e, t, r) {
          t.exports = function (e, t, r) {
            var l,
              n,
              o,
              r = r.flexStyle.mainInnerBefore,
              f = -1;
            if ("flex-end" === t)
              for (l = e.mainSpace, l += r; (o = e.children[++f]); )
                (o.flexStyle.mainStart = l), (l += o.flexStyle.mainOuter);
            else if ("center" === t)
              for (l = e.mainSpace / 2, l += r; (o = e.children[++f]); )
                (o.flexStyle.mainStart = l), (l += o.flexStyle.mainOuter);
            else if ("space-between" === t)
              for (
                n = e.mainSpace / (e.children.length - 1), l = 0, l += r;
                (o = e.children[++f]);
              ...
              for (
                l = (n = (2 * e.mainSpace) / (2 * e.children.length)) / 2,
                  l += r;
                (o = e.children[++f]);
      ...
      14: [
        function (e, t, r) {
          t.exports = function (e, t, r) {
            var l = e[t];
            if ((o = String(l).match(f))) {
              var n = o[1],
                o = o[2];
              if ("px" === o) return +n;
              else if ("cm" === o) return 0.3937 * n * 96;
              else if ("in" === o) return 96 * n;
              else if ("mm" === o) return (0.3937 * n * 96) / 10;
              else if ("pc" === o) return (12 * n * 96) / 72;
              else if ("pt" === o) return (96 * n) / 72;
              else if ("rem" === o) return 16 * n;
              else {
                o = l;
                n = r;
                return (
        ...
        function (e, t, r) {
          t.exports = function (e) {
            ...
            if (e instanceof Element) {
              var r,
                l = e.hasAttribute("data-style"),
                n = l
                  ? e.getAttribute("data-style")
                  : e.getAttribute("style") || "",
                l =
                  (l || e.setAttribute("data-style", n),
                  (window.getComputedStyle && getComputedStyle(e)) || {}),
                o = t,
                f = l;
              for (r in o) r in f && !p.test(r) && (o[r] = f[r]);
              var i,
                s,
                a,
                y,
              ...
              for (y in c)
                y in x
                  ? (c[y] = x[y])
                  : (i = y.replace(/[A-Z]/g, "-$&").toLowerCase()) in x &&
                    (c[y] = x[i]);
              "-js-display" in x && (c.display = x["-js-display"]);
              for (var S = t, m = n; (s = u.exec(m)); ) {
                var d = s[1].toLowerCase().replace(/-[a-z]/g, function (e) {
                  return e.slice(1).toUpperCase();
                });
                S[d] = s[2];
              }
              for (a in t) t[a] = h(t, a, e);
          ...
          var u = /([^\s:;]+)\s*:\s*([^;]+?)\s*(;|$)/g,
            p = /^(alignSelf|height|width)$/,
            h = e("./getComputedLength");
        },
        ...
        function (e, t, r) {
          function y(e) {
            var t = e instanceof Element,
              ...
              t = t && e.currentStyle && e.currentStyle["-js-display"];
            return l.test(r) || n.test(t);
          }
          t.exports = function (e) {
            var t = [];
            return (
              (function e(t, r) {
                for (
                  ...
                  var i,
                    s = 3 === l.nodeType && !/^\s*$/.test(l.nodeValue),
                    s =
                      (n &&
                        s &&
                        ((s = l),
                ...
                var a = { element: t, children: o };
                return n && ((a.style = c(t).style), r.push(a)), a;
              })(e, t),
              t
            );
          };
          var c = e("../read"),
            l = /(^|;)\s*display\s*:\s*(inline-)?flex\s*(;|$)/i,
            n = /^(inline-)?flex$/i;
        },
        { "../read": 15 },
      ],
          ...
          t.exports = function (e) {
            ...
            for (var l, n = -1; (l = e.children[++n]); ) {
              ...
              (o.boxSizing = "content-box"),
                (o.display = "block"),
                (o.position = "absolute"),
                "auto" !== l.flexStyle[f[0]] &&
                  (o.width = i(
                    l.flexStyle[f[0]] -
                      l.flexStyle[f[0] + "InnerBefore"] -
                      l.flexStyle[f[0] + "InnerAfter"] -
                      l.flexStyle[f[0] + "BorderBefore"] -
                      l.flexStyle[f[0] + "BorderAfter"]
                  )),
                "auto" !== l.flexStyle[f[1]] &&
                  (o.height = i(
                    l.flexStyle[f[1]] -
                      l.flexStyle[f[1] + "InnerBefore"] -
                      l.flexStyle[f[1] + "InnerAfter"] -
                      l.flexStyle[f[1] + "BorderBefore"] -
                      l.flexStyle[f[1] + "BorderAfter"]
                  )),
